...
hyperfine \
  ...
  --prepare='rm -rf website-bunnode/www/' 'cd website-bunnode && bun --bun run run-build.mjs www' \
  --prepare='rm -rf website-bunbuns/www/' 'cd website-bunbuns && bun --bun run run-build.mjs www'
